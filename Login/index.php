        ...
        <div class="container">
          <div class="row">
           ...
           <?php    } ?>
              ...
              <button onclick="window.location.href='../Cadastros/cadastroUsuario.php';" class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit">
					Cadastrar
			  </button>
