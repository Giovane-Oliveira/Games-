...
CREATE TABLE IF NOT EXISTS `chat` (
  ...
  `id_conversa` int(100) DEFAULT NULL,
  `mensagem` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela projetogame.chat: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `chat` DISABLE KEYS */;
INSERT INTO `chat` (`id`, `id_de`, `id_para`, `id_game`, `id_conversa`, `mensagem`) VALUES
	(1, 1, 4, 4, 1, 'ola'),
	(2, 1, 4, 4, 1, 'Tudo bem ?'),
	(3, 4, 1, 4, 1, 'tudo e com vo?'),
	(4, 4, 1, 2, 4, 'opa'),
	(5, 1, 4, 2, 4, 'opa'),
	(6, 4, 3, 3, 4, 'opa'),
	(7, 4, 2, 1, 4, 'opa'),
	(8, 1, 3, 3, 1, 'tudo e com vo?'),
	(9, 4, 1, 2, 4, 'dale'),
	(10, 4, 1, 2, 4, 'Quando posso pegar?'),
	(11, 1, 4, 3, 1, 'opa');
...
INSERT INTO `game` (`id`, `nomeGame`, `descricao`, `imgCapa`, `disponivel`, `usuario_id`, `genero_id`) VALUES
	(1, 'Dead Rising 4 - Xbox One', 'Dead Rising 4 marca o retorno do jornalista fotogrÃ¡fico Frank West em um novo capÃ­tulo de uma das franquias de jogos de zumbis mais populares de todos os tempos. Com um nÃ­vel inigualÃ¡vel de personalizaÃ§Ã£o de armas e personagens, novas caracterÃ­sticas ambiciosas como novas classes de zumbis e exoarmaduras, Dead Rising 4 traz uma experiÃªncia emocionante, na qual os jogadores exploram, buscam itens e lutam para sobreviver em um ambiente aberto Ã©pico.', '../Imagens/game/cf8ce9fe1413b96152aafa6385da8fa7.jpg', 0, '4', 1),
	...
	(3, 'The sims 4 - Xbox One', 'The Sims 4. The Sims 4 Ã© o quarto tÃ­tulo da franquia de jogos eletrÃ´nicos de simulaÃ§Ã£o de vida The Sims, desenvolvido pela Maxis e The Sims Studio, e publicado pela Electronic Arts.', '../Imagens/game/cf5003eb8428a913deaf3aed357d9fb5.jpg', 0, '4', 7),
	(4, 'Need for Speed Rivals - PS3', 'O jogo permanece com o estilo de seus antecessores sobre pistas de personalizaÃ§Ãµes de veÃ­culos estÃ©ticas, como atualizaÃ§Ãµes de desempenho, trabalhos de pintura, decalques e juntas podem ser modificados. A Ferrari foi oficialmente retornada Ã  franquia, pela primeira vez em 11 anos, desde Hot Pursuit 2 em 2002 (embora jÃ¡ apareceu em 2009 com a mudanÃ§a de conteÃºdo para download do Xbox 360) com o F12berlinetta ser o primeiro veÃ­culo confirmado, a Ferrari.', '../Imagens/game/cc38ab95090a5d8f6d7f24b7f9ad1e94.jpg', 1, '4', 10);
...
-- Copiando dados para a tabela projetogame.situacao: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela projetogame.solicitacao: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `solicitacao` DISABLE KEYS */;
INSERT INTO `solicitacao` (`id`, `data`, `usuario_id`, `game_id`, `situacao_id`, `dono_id`) VALUES
	(51, '2019-11-26', 1, 4, 1, 4),
	(52, '2019-11-26', 1, 3, 1, 4),
	(53, '2019-11-26', 1, 1, 1, 4),
	(54, '2019-11-26', 1, 4, 1, 4),
	(55, '2019-11-26', 1, 3, 2, 4),
	(56, '2019-11-26', 1, 4, 3, 4);
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `rua`, `bairro`, `cidade`, `casa`, `estado`, `cpf`, `cep`, `telefone`, `senha`, `imgPerfil`) VALUES
	...
	(4, 'Alison Dias', 'alisoondias@gmail.com', 'Rua Gustavo Peixoto', 'TibiriÃ§a', 'Cachoeira do Sul', 1215, 'RS', '03701110024', 96503680, 2147483647, '1234', '../Imagens/user/7cf003c0346a52a7084e612d5aabc4a5.png');
